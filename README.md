...
Plugin via marketplace, MCP auto-registered, hooks + skills + 19 slash commands

Codex CLI

`~/.codex/config.toml` (merged), instructions.md

Gemini CLI

`~/.gemini/settings.json` (merged), GEMINI.md
